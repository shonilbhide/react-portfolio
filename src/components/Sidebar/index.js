...
import LogoS from '../../assets/images/profile-pic.png'
// import LogoSubtitle from '../../assets/images/sb.png'
...
const Sidebar = () => (
    <div className='nav-bar'>
        ...
        <ul>
            <li>
                <a target='' rel='' href='https://www.linkedin.com/in/shonilbhide/'>
                <FontAwesomeIcon icon={faLinkedin} color ="#4d4d4e" />
                </a>
            </li>
            <li>
                <a target='' rel='' href='https://github.com/shonilbhide'>
