...
function HeroSection() {
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            Hello, <br />
            This is {' '}
            <span className=" text-blue-500">Shonil Bhide</span>
            {` , I'm a `}
          ...
          <div className="flex items-center gap-3">
            <Link href="#contact" className="bg-gradient-to-r to-blue-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-blue-500 hover:to-[#001a33]">
        ...
        <div className="order-1 lg:order-2 from-[#000d1a] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#001a33]">
          ...
          <div className="overflow-hidden border-t-[2px] border-blue-900 px-4 lg:px-8 py-4 lg:py-8">
  ...
  <span className="mr-2 text-green-400">datetime</span>
  <br/>
  <span className="mr-2 text-pink-400">class</span>
  <span className="mr-2 text-green-400">Shonil</span>
  <span className="mr-2 text-white">:</span>
  <br/>
  <span className="ml-4 mr-2 text-pink-400">def</span>
